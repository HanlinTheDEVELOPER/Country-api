...
function displayCountry(country) {
    ...
    countryDetails.insertAdjacentHTML("beforeend", `
    <div class="selection">
      ...
      <div class="info">
        <div class="first-info">
          <div class="first-col">
            ...
            <h3>Native name: <span>${generateNativeName(country.name.nativeName)}</span></h3>
          ...
          <div class="second-col">
            ...
            <h3>Currencies: <span>${generateCurrencies(country.currencies)}</span></h3>
            <h3>Language: <span>${generateLanguaes(country.languages)}</span></h3>
          </div>
        </div>
